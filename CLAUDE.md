# CLAUDE.md — Interactive Data App (HO13)
...
## About this project
An interactive data app that processes your files.
**Primary way to do it:** Claude Cowork (drop your files in and have it process them) — **no API key needed.**
...
- It's the **Interactive Data App** hands-on. File processing in Cowork; any main.py is optional/advanced.
