...
You do **not** need this for the course. If you later want to generate the report on your own
computer, **`main.py`** in this folder is a ready-to-run Python script that produces a
Markdown summary. It uses only the Python standard library — no API key, nothing to install.
Run `python main.py sample_data/sales.csv` and it writes a report file next to the CSV.
