...
You don't need an API key, a credit card, or the terminal. Everything here runs on your
normal **Claude.ai** subscription (Pro or Team) using **Cowork** — the workspace where you
drag in files and Claude works on them for you.

Each `samples/sample-01 … sample-05` folder is **copy-and-use**:

1. Open the sample folder's `README.md`.
2. Open **Claude.ai → Cowork** and drag in the files from that sample's `sample_data/`.
3. Copy the **ready-made prompt** in the README and paste it in.
4. Claude does the work and gives you the result to download. **No API key needed.**

Each sample also includes a ready-to-run `main.py` as an **optional, advanced** reference if
you ever want to run it on your own computer instead — but that is never required.
...
3. Replace this section of the README with: what you built, the problem it solves, and how
   you used it.
