...
3. A worked `main.py` reference script under **Optional — automate it with code (advanced)**,
   for anyone who later wants to run it on their own computer. That path is never required.
